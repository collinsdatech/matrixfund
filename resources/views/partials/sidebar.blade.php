					...
					<ul>
						...
						<li class="submenu-open">
							...
							<ul>
								...
								<li><a href="#"><i class="ti ti-link fs-16 me-2"></i><span>Affiliates</span></a></li>
								<li><a href="{{ route('user.notifications') }}"><i class="ti ti-bell fs-16 me-2"></i><span>Notifications</span></a></li>
								<li><a href="#"><i class="ti ti-blackboard fs-16 me-2"></i><span>Webinars</span></a></li>
								<li><a href="#"><i class="ti ti-filter fs-16 me-2"></i><span>Screener</span></a></li>
								<li><a href="#"><i class="ti ti-trophy fs-16 me-2"></i><span>Technical Analysis</span></a></li>
								<li><a href="#"><i class="ti ti-calendar fs-16 me-2"></i><span>Economic Calendar</span></a></li>
								<li><a href="{{ route('user.settings') }}"><i class="ti ti-settings fs-16 me-2"></i><span>Settings</span></a></li>
							</ul>
					</ul>
				</div>
			</div>
