                                ...
                                <div class="card">
                                    <div class="card-body p-5">
                                        <div class="login-userheading">
                                            <h3>Sign In</h3>
                                            <h4>Access the {{ setting('siteName') }} Dashboard using either your username or
                                                internent Id and password.</h4>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Username or Internet ID <span class="text-danger">
                                                    *</span></label>
                                            <div class="input-group">
                                                <input type="text" id="identifier" name="identifier"
                                                    value="{{ old('identifier') }}"
                                                    class="form-control border-end-0 @error('identifier') is-invalid @enderror"
                                                    required>
                                        ...
                                        <div class="signinform">
                                            <h4>New on our platform?<a href="{{ route('register') }}" class="hover-a">
                                                    Create an
                                                    account</a></h4>
                                        </div>
